...
class Host(Model):
    ...
    arch = fields.CharField(max_length=64, null=True)
    instance_id = fields.CharField(max_length=64, null=True)
    ...
    cpu_sockets = fields.CharField(max_length=64, null=True)
    cpu_subtype = fields.CharField(max_length=64, null=True)
    cpu_microcode = fields.CharField(max_length=64, null=True)
    physical_memory = fields.CharField(max_length=64, null=True)
    kernel_version = fields.CharField(max_length=64, null=True)  # 内核版本，与Go版本对应
    board_model = fields.CharField(max_length=128, null=True)
    board_serial = fields.CharField(max_length=128, null=True)
    board_vendor = fields.CharField(max_length=128, null=True)
    board_version = fields.CharField(max_length=64, null=True)
    hardware_model = fields.CharField(max_length=128, null=True)
    hardware_serial = fields.CharField(max_length=128, null=True)
    hardware_vendor = fields.CharField(max_length=128, null=True)
    hardware_version = fields.CharField(max_length=64, null=True)
    computer_name = fields.CharField(max_length=128, null=True)
    uuid = fields.CharField(max_length=128, null=True)
    total_uptime_seconds = fields.CharField(max_length=64, null=True)
    build = fields.CharField(max_length=64, null=True)
    major = fields.CharField(max_length=16, null=True)
    minor = fields.CharField(max_length=16, null=True)
    patch = fields.CharField(max_length=16, null=True)
    version = fields.CharField(max_length=128, null=True)
    org = fields.CharField(max_length=128, null=True)
