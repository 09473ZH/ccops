                ...
                <ul className="ml-4 flex items-center">
                  {items.map((item) => (
                    <li
                      ...
                      className={cn(
                        'relative mx-1 cursor-pointer rounded px-3 py-1.5 text-sm text-gray transition-colors hover:bg-hover hover:text-gray-800 dark:hover:bg-gray-700 dark:hover:text-gray-200',
                        activeKey === item.key &&
