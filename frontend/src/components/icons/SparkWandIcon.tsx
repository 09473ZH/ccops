...
export default function SparkWandIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="sparkWandGradient" x1="0%" y1="0%" x2="100%" y2="100%">
