...
import { TaskOutput } from '@/api/services/task';
import { CommandEvent } from '@/pages/quick-command/components/StatusDisplay';
...
export const useQuickCommand = create<QuickCommandState>((set, get) => {
  ...
  return {
    ...
    setSelectedHosts: (hosts) => {
      if (Array.isArray(hosts) && hosts.every((host) => typeof host === 'number')) {
